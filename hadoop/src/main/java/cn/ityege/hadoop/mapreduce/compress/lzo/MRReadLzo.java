package cn.ityege.hadoop.mapreduce.compress.lzo;
...
public class MRReadLzo extends Configured implements Tool {
    ...
    public int run(String[] args) throws Exception {
        ...
        //input：配置输入
        Path inputPath = new Path("data\\output\\mr\\Compress\\lzo1");
        ...
        //output：配置输出
        Path outputPath = new Path("data\\output\\mr\\Compress\\lzo2");
